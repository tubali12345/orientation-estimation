...
def _load_model_from_checkpoint(checkpoint_path: str) -> SeldModelZeroShot:
...
def eval(model: SeldModelZeroShot, dataloader: DataLoader, output_dir: str, device: str):
    validator = ZeroShotValidator(torch.device(device))
...
if __name__ == "__main__":
    model_path = "/home/turib/thesis_git/model_weights/vctk/zeroshot_rm_rs/checkpoints/epoch_159.ckpt"
    dataset_path = "/ssd3/VCTK-Corpus_rs_rm/test/"
    output_dir = "plots/vctk/zeroshot_rm_rs"
