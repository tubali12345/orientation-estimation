...
def eval(model: SeldModelAnchor, dataloader: DataLoader, device: str):
...
if __name__ == "__main__":
    model = _load_model_from_checkpoint(
        "/home/turib/thesis/model_weights_rp_rm_rr_ds_reg_pair_diffprod/checkpoints/epoch_85.ckpt"
    )
    data_loader = init_data_module(
        {
            "data_path": "/ssd2/en_commonvoice_17.0_rs_rm_rr_ds_pair_2",
            "dataset_params": {
                "duration": 10,
                "sr": 44100,
            },
